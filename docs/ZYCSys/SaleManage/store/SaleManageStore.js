...
let SaleManageActions = require('../action/SaleManageActions')
let Utils = require('../../../public/script/utils')
import Common from '../../../public/script/common'

let SaleManageStore = Reflux.createStore({
  listenables: [SaleManageActions],
  filter: {},
  recordSet: [],
  startPage: 0,
  pageRow: 0,
...
module.exports = SaleManageStore