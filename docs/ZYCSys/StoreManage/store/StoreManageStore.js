...
let StoreManageActions = require('../action/StoreManageActions')
let Utils = require('../../../public/script/utils')
import Common from '../../../public/script/common'

let StoreManageStore = Reflux.createStore({
  listenables: [StoreManageActions],
  filter: {},
  recordSet: [],
  startPage: 0,
  pageRow: 0,
...
module.exports = StoreManageStore